...
function getRandomFlavors(arr1, arr2, arr3, arr4){
    ...
    for(let i = 0; i < 31; i++)
    {
        ...
        if(randNum1 === 1)
        {
            ...
            newArr.push(arr1[randNum2]);
        } else if(randNum1 === 2)
        {
            while(checkDuplicate(newArr, arr2[randNum2] === true))
            {                
                randNum2 = Math.floor(Math.random() * 22) + 1;
                checkDuplicate(newArr, arr2[randNum2]);
            }
            newArr.push(arr2[randNum2]);
        } else if(randNum1 === 3)
        {
            while(checkDuplicate(newArr, arr3[randNum2] === true))
            {                
                randNum2 = Math.floor(Math.random() * 22) + 1;
                checkDuplicate(newArr, arr3[randNum2]);
            }
            newArr.push(arr3[randNum2]);
        } else if(randNum1 === 4)
        {
            while(checkDuplicate(newArr, arr4[randNum2] === true))
            {                
                randNum2 = Math.floor(Math.random() * 22) + 1;
                checkDuplicate(newArr, arr4[randNum2]);
            }
            newArr.push(arr4[randNum2]);
        }
    }
